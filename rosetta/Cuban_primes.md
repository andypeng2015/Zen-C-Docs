...
---
**Attribution:** This is a community solution for the Rosetta Code task [**Cuban primes**](https://rosettacode.org/wiki/Cuban_primes) in Zen C.

*This article uses material from the Rosetta Code article **Cuban primes**, which is released under the [GNU Free Documentation License 1.3](https://www.gnu.org/licenses/fdl-1.3.html). A list of the original authors can be found in the [page history](https://rosettacode.org/wiki/Cuban_primes?action=history).*
